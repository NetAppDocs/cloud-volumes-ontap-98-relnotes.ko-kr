...
https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/task-getting-started-aws-c2s.html#limitations["AWS C2S의 Cloud Volumes ONTAP에 대한 제한 사항을 봅니다"^].
